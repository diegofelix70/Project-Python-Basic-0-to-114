...
background_image = pygame.image.load(r'C:\Users\diego\OneDrive\Imagens\@Progamação\Python\Desafios\fundo.jpg')

# Carregando a imagem do pássaro
bird_image = pygame.image.load(r'C:\Users\diego\OneDrive\Imagens\@Progamação\Python\Desafios\bird.png')
bird_image = pygame.transform.scale(bird_image, (BIRD_WIDTH, BIRD_HEIGHT))  # Redimensionando a imagem
